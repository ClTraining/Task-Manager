...
//    {
//        private readonly IEnumerable<Command> commandHandlers;

//        public ConsoleHelper(IEnumerable<Command> commandHandlers)
//        {
...
//        {
//            var matching = Substitute.For<Command>();
//            var notMatching = Substitute.For<Command>();
//            var consoleHelper = new ConsoleHelper(new List<Command> { notMatching, matching });
...
//        {
//            var handler = Substitute.For<Command>();
//            const string command = "list 100";
//            handler.Matches(command).Returns(true);
//            var helper = new ConsoleHelper(new List<Command> { handler });
